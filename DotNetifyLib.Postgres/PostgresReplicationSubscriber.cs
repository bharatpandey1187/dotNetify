        ...
        private async Task SubscribeAsync()
        {
            ...
            await foreach (var message in replication)
            {
                ...
                else if (messageType == typeof(RelationMessage))
                {
                    ...
                    if (!_relations.ContainsKey(relationMsg.RelationId))
                    {
                        _relations.Add(relationMsg.RelationId, new Relation
                        {
                            ...
                            SchemaName = relationMsg.Namespace,
                ...
                else if (messageType == typeof(InsertMessage))
                {
                    ...
                    var relation = _relations.ContainsKey(insertMsg.Relation.RelationId) ? _relations[insertMsg.Relation.RelationId] : null;
                    if (relation != null)
                    {
                        relation.OperationName = "Insert";
                    }
                ...
                else if (messageType == typeof(DefaultUpdateMessage))
                {
                    ...
                    var relation = _relations.ContainsKey(updateMsg.Relation.RelationId) ? _relations[updateMsg.Relation.RelationId] : null;
                    if (relation != null)
                    {
                        relation.OperationName = "Update";
                    }
                ...
                else if (messageType == typeof(KeyDeleteMessage))
                {
                    ...
                    var relation = _relations.ContainsKey(deleteMsg.Relation.RelationId) ? _relations[deleteMsg.Relation.RelationId] : null;
                    if (relation != null)
                    {
                        relation.OperationName = "Delete";
                    }
